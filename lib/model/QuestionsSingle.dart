...
//
//     final questionsSingle = questionsSingleFromJson(jsonString);

import 'dart:convert';

QuestionsSingle questionsSingleFromJson(String str) =>
    QuestionsSingle.fromMap(json.decode(str));

String questionsSingleToJson(QuestionsSingle data) => json.encode(data.toMap());

class QuestionsSingle {
  Data data;
  ...
  factory QuestionsSingle.fromMap(Map<String, dynamic> json) => QuestionsSingle(
