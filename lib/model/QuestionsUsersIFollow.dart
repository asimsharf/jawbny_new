...
//
//     final questionsUsersIFollow = questionsUsersIFollowFromJson(jsonString);

import 'dart:convert';

QuestionsUsersIFollow questionsUsersIFollowFromJson(String str) =>
    QuestionsUsersIFollow.fromMap(json.decode(str));

String questionsUsersIFollowToJson(QuestionsUsersIFollow data) =>
    json.encode(data.toMap());

class QuestionsUsersIFollow {
  int currentPage;
  List<Datum> data;
  String firstPageUrl;
  int from;
  ...
  factory QuestionsUsersIFollow.fromMap(Map<String, dynamic> json) =>
      QuestionsUsersIFollow(
