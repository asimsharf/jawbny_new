...
//
//     final PollsMy = PollsMyFromJson(jsonString);

import 'dart:convert';

PollsMy PollsMyFromJson(String str) => PollsMy.fromMap(json.decode(str));

String PollsMyToJson(PollsMy data) => json.encode(data.toMap());
...
class PollsMy {
  ...
  factory PollsMy.fromMap(Map<String, dynamic> json) => PollsMy(
        data: json["data"] == null
            ? null
