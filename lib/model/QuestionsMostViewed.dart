...
//
//     final questionsMostViewed = questionsMostViewedFromJson(jsonString);
...
String questionsMostViewedToJson(QuestionsMostViewed data) =>
...
class QuestionsMostViewed {
  ...
  factory QuestionsMostViewed.fromMap(Map<String, dynamic> json) =>
      QuestionsMostViewed(
        data: json["data"] == null
            ? null
